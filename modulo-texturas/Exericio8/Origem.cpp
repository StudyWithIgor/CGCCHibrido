...
ParsedOBJ parseArquivoOBJ(const std::string &mtlPath);
...
int main()
{
    ...
    ParsedOBJ parsedObj = parseArquivoOBJ(PASTA_RECURSOS + "SuzanneTriTextured.obj");
    string texturePath = getTextura(parsedObj.nomeArquivoMTL);
...
ParsedOBJ parseArquivoOBJ(const std::string &nomeArquivo)
{
